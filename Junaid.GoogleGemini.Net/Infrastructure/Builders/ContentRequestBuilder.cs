...
public class ContentRequestBuilder
{
    ...
    /// <see cref="GenerationConfig.Temperature"/> for the July-August 2026 deprecation note (ignored on
    /// <c>gemini-3.8-flash</c>/<c>gemini-3.7-flash</c>/<c>gemini-3.6-flash</c>/<c>gemini-3.5-flash-lite</c> and later).
    /// </summary>
